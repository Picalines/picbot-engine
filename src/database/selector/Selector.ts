...
interface EntitySelectorDefinition<E extends EntityType, Vars extends SelectorVars = {}> {
    /**
...
export interface EntitySelector<E extends EntityType, Vars extends SelectorVars = {}> extends EntitySelectorDefinition<E, Vars> { }

/**
 * Селектор сущности в базе данных. Используется в
 * методе [[BotDatabase.selectEntities]]
 */
export class EntitySelector<E extends EntityType, Vars extends SelectorVars = {}> {
    /**
